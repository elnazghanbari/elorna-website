    ...
    <main style={styles.page}>
        ...
        <div style={styles.navActions}>
          <details className="language-menu" style={styles.languageMenu}>
            <summary aria-label="Choose language" style={styles.languageSummary}>
              <span aria-hidden="true">◎</span><span>SV</span>
            </summary>
          ...
          <a href="#contact" className="nav-lux-cta" style={styles.navButton} aria-label="Start building with ELORNA">
            <span>Börja bygga</span><span aria-hidden="true">→</span>
          </a>
        </div>
      </header>
      ...
      <section id="top" style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          <p style={styles.kicker} className="micro-kicker">AI • IT • FÖRETAG • FRAMTID</p>

          <h1 style={styles.heroTitle}>
            Bygg företaget.
            <br />
            <span style={styles.goldText}>Forma framtiden.</span>
          </h1>
          ...
          <div style={styles.badges}>
            <span style={styles.badge} className="micro-badge">AI-driven</span>
            <span style={styles.badge} className="micro-badge">Grundarfokuserad</span>
            <span style={styles.badge} className="micro-badge">Tillväxtorienterad</span>
          </div>
        </div>
      ...
      <section style={styles.uspSection}>
        <p style={styles.kicker} className="micro-kicker">VARFÖR ELORNA</p>
        <span style={styles.goodLabel}>USP — UNIKT KUNDERBJUDANDE</span>
        <h2 style={styles.uspTitle}>Till skillnad från separata AI- och affärsverktyg kopplar ELORNA samman grundarens resa från idé till lansering, försäljning och tillväxt i ett AI-assisterat ekosystem.</h2>
        ...
        <div style={styles.positioningGrid}>
          <div className="premium-panel language-premium" style={styles.positioningCard}>
            <span style={styles.goodLabel}>POSITIONERING</span>
          ...
          <div className="premium-panel language-premium" style={styles.positioningCard}>
            <span style={styles.goodLabel}>KÄRNLÖFTE</span>
            <p style={styles.languageWords}>En sammanlänkad infrastruktur för att bygga, sälja och växa — med AI-stöd och grundarens kontroll.</p>
          </div>
        </div>
        <div style={styles.uspBadge}>AI-assisterat • Grundarkontrollerat • Sammanlänkat från grunden</div>
      </section>
      ...
      <section style={styles.intro}>
        <p style={styles.kicker} className="micro-kicker">ELORNA-SYSTEMET</p>

        <h2 style={styles.sectionTitle}>
          One infrastructure.
          <br />
          <span style={styles.goldText}>Gränslösa möjligheter.</span>
        </h2>
        ...
        {businessStages.map((stage) => (
          <div key={stage.number} className="premium-panel stage-premium" style={styles.stage}>
            ...
            <div style={styles.stageMeta}>
              <p style={styles.stageMetaText}><strong>Passar bäst för:</strong> {stage.bestFor}</p>
      ...
      <section id="vision" style={styles.vision}>
        ...
        <p style={styles.kicker} className="micro-kicker">VÅR VISION</p>
      ...
      <section style={styles.trust}>
        <div style={styles.trustItem}>
          ...
          <h3 style={styles.trustTitle}>SMARTARE</h3>
        ...
        <div style={styles.trustItem}>
          <span style={styles.trustIcon}>◈</span>
          <h3 style={styles.trustTitle}>ENKLARE</h3>
          <p style={styles.trustText}>
        ...
        <div style={styles.trustItem}>
          <span style={styles.trustIcon}>△</span>
          <h3 style={styles.trustTitle}>SKALBART</h3>
          <p style={styles.trustText}>
        ...
        <div style={styles.trustItem}>
          <span style={styles.trustIcon}>◎</span>
          <h3 style={styles.trustTitle}>GLOBALT</h3>
          <p style={styles.trustText}>
      ...
      <section style={styles.proofSection}>
        <div>
          <p style={styles.kicker} className="micro-kicker">SÅ KAN ARBETET SE UT</p>
          <h2 style={styles.proofTitle}>Ett transparent exempel på arbetsflöde — inte ett påhittat kundresultat.</h2>
      ...
      <section style={styles.founderSection}>
        <div>
          <p style={styles.kicker} className="micro-kicker">GRUNDARLETT</p>
          <h2 style={styles.founderTitle}>Byggt med ansvar, tydlighet och grundarens kontroll.</h2>
        </div>
        <div className="premium-panel founder-premium" style={styles.founderCard}>
          <span style={styles.contactLabel} className="micro-label">GRUNDARE</span>
      ...
      <section style={styles.noticeSection}>
        <p style={styles.noticeText}>
          <strong>Information om kapital:</strong> ELORNA may provide general readiness tools, educational information and introductions. It does not guarantee funding, profit, investment performance or approval, and does not present itself as a regulated investment adviser or broker.
        </p>
      </section>
      ...
      <section id="start" style={styles.cta}>
        ...
        <p style={styles.kicker} className="micro-kicker">NÄSTA KAPITEL BÖRJAR HÄR</p>

        <h2 style={styles.ctaTitle}>
          Are you ready to
          <br />
          <span style={styles.goldText}>bygga ditt avtryck?</span>
        </h2>
        ...
        <a href="#contact" className="lux-button lux-button-primary" style={styles.ctaButton} aria-label="Kontakt ELORNA to start building">
          START WITH ELORNA
        </a>
      </section>
      ...
      <section style={styles.languageSection}>
        <div>
          <p style={styles.kicker} className="micro-kicker">SÅ KOMMUNICERAR ELORNA</p>
          <h2 style={styles.languageTitle}>Tydlighet du kan bygga vidare på.</h2>
        </div>
        <div style={styles.languageGrid}>
          <div className="premium-panel language-premium" style={styles.languageCard}>
            <span style={styles.goodLabel}>REKOMMENDERADE ORD</span>
            <p style={styles.languageWords}>opportunity • clarity • connected • precise • responsible • useful</p>
          </div>
          <div className="premium-panel language-premium" style={styles.languageCard}>
            <span style={styles.avoidLabel}>ORD VI UNDVIKER</span>
      ...
      <section id="contact" style={styles.contactSection}>
        <div style={styles.contactIntro}>
          <p style={styles.kicker} className="micro-kicker">KONTAKTA ELORNA</p>
          <h2 style={styles.contactTitle}>Starta en seriös dialog med ELORNA.</h2>
        ...
        <div style={styles.socialStrip}>
          <span style={styles.contactLabel} className="micro-label">FÖLJ ELORNA</span>
        ...
        <div style={styles.contactLayout}>
          ...
          >
            ...
            <button type="submit" style={styles.formButton}>SKICKA TILL ELORNA</button>
            <p style={styles.formNote}>Ditt meddelande skickas säkert till contact@elorna.net. Ingen e-postapp öppnas.</p>
          </form>
          ...
          <div style={styles.contactGrid}>
            <a href="mailto:contact@elorna.net" className="contact-card-link premium-panel premium-contact-card" style={styles.contactCard}>
              <span style={styles.contactLabel} className="micro-label">ALLMÄN KONTAKT</span>
